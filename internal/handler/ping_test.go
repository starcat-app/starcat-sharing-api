...
func TestHandlePingV1_OK(t *testing.T) {
	...
	if env.Data.Service != "sharing" {
		t.Errorf("data.service: want 'sharing', got %q", env.Data.Service)
	}
...
func TestHandlePingV1_ServiceNamePassthrough(t *testing.T) {
	cases := []string{"sharing", "weekly", "sharing", "wiki", "custom-fork"}
